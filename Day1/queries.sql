...
CREATE TABLE customer (
   ...
   active boolean  -- added directly during creation
);
...
SELECT customer_id, first_name, last_name FROM customer WHERE first_name = 'Hina' AND last_name = 'khan';
SELECT customer_id, first_name, last_name FROM customer WHERE first_name IN ('John','David','James');
SELECT first_name, last_name FROM customer WHERE first_name LIKE '%ru%';
SELECT first_name, last_name FROM customer WHERE first_name LIKE 'dr%';
